...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($payment_method == 'cartao') {
        ...
        echo "CVV: $cvv<br>";
        echo "Pagamento realizado com sucesso com sucesso!<br>" . "<a href='Index.php'>Voltar ao site</a>";
    } else {
        echo "Pagamento em dinheiro cadastrado com sucesso!<br>";
        echo "Nome: $nome<br>";
        echo "Valor: R$ $amount<br>";
        echo "Pagamento realizado com sucesso!<br>" . "<a href='Index.php'>Voltar ao site</a>";
    }
} else {
