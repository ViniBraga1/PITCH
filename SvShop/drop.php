...
<body>
    ...
    <section id="i3">a</section>
    <section id="FlexCorteiz">
    <section id="DROPP"></section>
    <section id="CorteizIMG"><a href="#" class="button">Confira</a></section>
    </section>


    <section id="hehe">Drop 2023!</section>
    <section id="GRIDProd">
        <div id="Roupa1"><section>Camiseta Sufgang</section>
                        <section>000Psy</section>
                        <section id="I2">199,90</section>
        </div>
        <div id="Roupa2"><section>Camiseta Sufgang</section>
            <section>SufYang</section>
            <section id="I2">199,90</section>
    </div>
    <div id="Roupa6"><section>Rain Jacket HIGH</section>
    <section>Chameleon Orange</section>
    <section id="I2">199,90</section>
    </div>
    </section>
    <section id="dropfinal"></section>
