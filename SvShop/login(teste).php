...
<section id="RodaPeInicial">
    ...
    <section id="POP">
        ...
        <div><input  type="email" placeholder="Username" id="Input-Email" name="username"></div>
        <div><input  type="text" placeholder="Email" id="Input-Email" name="email"></div>
        <div><input  type="password" placeholder="Senha" id="Input-Email" name="senha"></div>
        <section><a href="#" class="button">Registrar</a></section>
        </form>
    </section>
</div>
